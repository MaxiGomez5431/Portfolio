...
function Hero() {
  ...
  return (
    ...
    <section className="flex justify-around content-center flex-col p-4 lg:gap-x-20 lg:flex-row ">
      ...
      <div className="flex justify-center text-center flex-col mt-5 lg:mt-16">
