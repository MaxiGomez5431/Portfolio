export default function Tooltip ({tooltipNumber, selectedNumber, text}) {
  return (
    <div className={`absolute left-[105%] rounded-2xl p-1 pl-2 pr-2 shadow-lg bg-brand-blue-50 duration-100 cursor-default ${selectedNumber === tooltipNumber ? 'opacity-100' : 'opacity-0'}`}>
      <p>{text}</p>
